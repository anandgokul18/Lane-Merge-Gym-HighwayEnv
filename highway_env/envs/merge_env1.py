...
class MergeEnv1(AbstractEnv):
    ...
    def _is_terminal(self) -> bool:
        ...
        return self.vehicle.crashed or self.vehicle.position[0] > 430 #370
    ...
    def _make_vehicles(self) -> None:
        ...
        ego_vehicle = self.action_type.vehicle_class(road, road.network.get_lane(("j", "k", 0)).position(110, 0), speed=20)
